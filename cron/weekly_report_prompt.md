...
## 1단계: Jira 티켓 조회
Atlassian MCP를 사용해서 EXAMPLE 프로젝트의 현재 활성 스프린트에서 assignee가 {{ASSIGNEE}}인 티켓들을 조회해줘.
- cloudId: 7553cfaa-fa16-484f-87f8-6c9b7f448d77
- JQL: project = EXAMPLE AND assignee = "{{ASSIGNEE}}" AND sprint in openSprints()
...
JSON 예시:
[{"ticket_key":"EXAMPLE-123","title_summary":"검색 API 개선","work_summary":"검색 응답 속도 최적화 작업 완료","status":"In Progress","has_update":true}]
